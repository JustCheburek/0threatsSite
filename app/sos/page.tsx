				...
				<MaxSize>
					...
					<PBox>
						...
						<PText>
							...
							<p className="red_line">
								Не вступайте в незарегистрированные организации. Участие в мероприятиях таких организаций может повлечь
								уголовное наказание.
							</p>
							<p className="red_line">
								Во время массовых беспорядков постарайтесь не попасть в толпу, как участников, так и зрителей. Вы можете
					...
					<PBox>
						...
						<PText>
							...
							<ul>
								<li>
									Основное правило – не допускайте действия, которые могут спровоцировать нападающих к применению оружия
							...
							<p className="red_line">
								...
								манеры поведения, тематику разговоров и т.д. Помните, что получив сообщение о Вашем захвате, спецслужбы
					...
					<PBox>
						...
						<PText>
							<ul>
								<li>
									Всегда контролируйте ситуацию вокруг себя, особенно когда находитесь на объектах транспорта, культурно
								...
								<li>
									В них могут быть закамуфлированы взрывные устройства (в банках из-под пива, сотовых телефонах и т.п.).
							...
							<p>
								Если вам стало известно о готовящемся или совершенном преступлении, немедленно сообщите об этом в органы
								ФСБ или МВД.
							</p>
						</PText>
					</PBox>
