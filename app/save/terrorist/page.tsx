							...
							<PText>
								<ul>
									...
									<li>
										...
										лестничные клетки и коридоры от загромождающих предметов;
									</li>
									<li>
										организовать дежурство жильцов вашего дома, которые будут регулярно обходить здание, наблюдая, все
										ли в порядке, обращая особое внимание на появление незнакомых лиц и автомобилей, разгрузку мешков и
										ящиков;
									</li>
									<li>
						...
						<PBox id="crowd">
							...
							<PText>
								<p className="red_line">
									...
									фактора террористического акта, люди гибнут и получают травмы еще и в результате давки, возникшей
									вследствие паники
								</p>
								<p className="red_line">
								...
								<ul>
									...
									<li>
										...
										прежде всего от сумки на длинном ремне и шарфа.
									</li>
									<li>
								...
								<p className="red_line">
									...
									экстремальной ситуации наиболее опасны (проходы между секторами на стадионе, стеклянные двери и
									перегородки в концертных залах и т.п.), обратите внимание на запасные и аварийные выходы, мысленно
						...
						<PBox id="hostage">
							...
							<PText>
								<p className="red_line">
									...
									они могут добиваться достижения политических целей, получения выкупа и т.п. Во всех случаях, Ваша
									жизнь становиться предметом торга для террористов. Захват может произойти в транспорте, в учреждении,
									на улице, в квартире.
								</p>
								<p className="red_line">
